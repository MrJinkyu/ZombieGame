...
function init(){
    ...
    let x = 0;
    let y = 0;
    setInterval(moveElement, 1000, zombies[i]);

        function moveElement(element) {

            let newX = randomNumber(fieldRect.left,fieldRect.right - Zombie.width);
            let newY = randomNumber(fieldRect.top,fieldRect.bottom - Zombie.height);
            ...
            // if(newX + Zombie.width > fieldRect.width){
            //     newX = fieldRect.width - Zombie.width;
            // }

            // if(newY + Zombie.height > fieldRect.height){
            //     newY = fieldRect.height - Zombie.height;
            // }
...
function addZombie(className,zombieType,count){
    for(let i=0; i<count; i++){
        ...
        const x = randomNumber(fieldRect.left,fieldRect.right-Zombie.width);
        const y = randomNumber(fieldRect.top,fieldRect.bottom-Zombie.height);
