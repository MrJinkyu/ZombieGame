...
function init(){
    ...
    setInterval(moveElement, 1000, zombies[i]);
        ...
        function moveElement(element) {
            ...
            if (deltaX + Zombie.width >= fieldRect.width){
                deltaX = fieldRect.width - Zombie.width;
            }
            if (deltaY + Zombie.height >= fieldRect.height){
                deltaY = fieldRect.height - Zombie.height;
            }
