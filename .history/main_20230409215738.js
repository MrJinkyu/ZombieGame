...
function init(){
    ...
    setInterval(moveElement, 1000, zombies[i]);
        ...
        function moveElement(element) {
            ...
            if(newX < fieldRect.left){
                newX = 0;
            }
            if(newY < fieldRect.top){
                newY = 0;
            }

            if(newX + Zombie.width > fieldRect.right){
                newX = fieldRect.right - Zombie.width;
            }

            if(newY + Zombie.height > fieldRect.bottom){
                newY = fieldRect.bottom - Zombie.height;
            }
