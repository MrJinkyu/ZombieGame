...
function init(){
    ...
    setInterval(moveElement, 1000, zombies[i]);
        ...
        function moveElement(element) {
            ...
            if (deltaX < fieldRect.left){
                deltaX = fieldRect.left;
            } 
            if (deltaY < fieldRect.top){
                deltaY = fieldRect.top;
            }
            if (deltaX + Zombie.width >= fieldRect.right){
                deltaX = fieldRect.right - Zombie.width;
            }
            if (deltaY + Zombie.height >= fieldRect.bottom){
                deltaY = fieldRect.bottom - Zombie.height;
            }
